...
class JobPostings(models.Model):
    ...
    # custom_ctc_range=models.CharField(max_length=50,default='not specified')
    ...
    # custom_job_level =models.CharField(max_length=50,default='not specified')
    ...
    decision_maker_email = models.CharField(max_length=100, default='')
...
class CandidateResume(models.Model):
    ...
    job_status = models.CharField(max_length=20,  null=True, blank=True, choices=JOB_STATUS)
