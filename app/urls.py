...
urlpatterns = [
    ...
    path('candidate/dashboard/', CandidateDashboard.as_view(), name='candidate-dashboard'),
    ...
    path('manager/jobs/not-approved/',NotApprovedJobs.as_view(),name='agency-job-posts' ),
    path('manager/jobs/not-assigned/',NotAssignedJobs.as_view(),name='agency-job-posts' ),
    path('manager/jobs/closed-hold/',ClosedHoldJobs.as_view(),name='agency-job-posts' ),
    path('manager/job/assign-recruiter/', AssignRecruiterView.as_view(), name='update-recruiters'),
    path('manager/job/assign-recruiter/by-location/<int:location_id>/', AssignRecruiterByLocationView.as_view(), name='update-recruiters'),
    path('manager/jobs/not-approved/<str:action>/<int:job_id>/',NotApprovedJobs.as_view(),name='agency-job-posts' ),
